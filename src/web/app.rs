...
use crate::web::handlers::identity::{
    ...
    do_google_sign_in, do_identity_welcome, do_steam_refresh, do_steam_sign_in, do_unlink_identity,
    google_callback, google_sign_in, google_start, identity_welcome, steam_app_only,
};
