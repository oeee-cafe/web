...
supporter-pack = 후원 팩
supporter-pack-lede = 오이카페는 무료이고, 앞으로도 무료입니다. 후원 팩을 구매하시면 오이카페 운영에 큰 힘이 됩니다.
supporter-pack-year = { $year } 팩
supporter-pack-what = 올해 팩을 사면 이름이 보이는 곳마다 올해의 표식이 붙고, 소개 페이지에 이름이 실립니다. 내년에는 내년 팩이 나옵니다.
supporter-pack-have = { $year } 팩을 가지고 계십니다. 고맙습니다.
supporter-pack-buy = { $year } 팩 구입
supporter-pack-restore = 구매 복원
supporter-pack-sign-in = 팩이 담길 계정이 필요하니 먼저 로그인해 주세요.
supporter-pack-none = 아직 { $year } 팩은 판매하지 않습니다.
supporter-pack-elsewhere = 팩은 iOS 앱과 Steam 앱 안에서 판매합니다.
