...
notification-comment-reply = 댓글 답글
notification-community-post = 새 커뮤니티 게시물
...
notification-action-mentioned-in-comment = { $postTitle }의 댓글에서 언급했습니다
notification-action-replied-to-post = 님이 그림에 답글을 그렸습니다
notification-action-replied-to-post-with-title = { $postTitle }에 답글을 그렸습니다
notification-action-replied-to-comment = { $postTitle }의 댓글에 답글을 남겼습니다
...
draw-guest-notice = 로그인하지 않았습니다. 저장하면 이 기기에만 보관됩니다.
draw-guest-save-confirm = 이 그림을 이 기기에 저장할까요? 로그인하면 임시 보관함에서 게시할 수 있습니다.
draw-guest-saved-title = 이 기기에 저장됨
draw-guest-saved = 이 그림은 사이트가 아니라 이 기기에만 있습니다. 로그인하면 임시 보관함에서 게시할 수 있고, 사본을 내려받아 둘 수도 있습니다.
draw-download-png = PNG 내려받기
draw-keep-drawing = 계속 그리기
draw-local-save-failed = 지금은 이 기기에 그림을 보관할 수 없습니다. 사본을 남기려면 PNG를 내려받으세요.
draw-upload-failed-kept = 그림을 게시하지 못했습니다. 이 기기의 임시 보관함에 남아 있으니 거기서 게시할 수 있습니다.
draw-upload-failed-lost = 그림을 게시하지 못했고, 이 기기에 보관할 수도 없습니다. 다시 시도하거나 PNG를 내려받으세요.
drafts-local-heading = 이 기기에 있는 그림
drafts-local-note = 이 그림들은 게시하기 전까지 이 기기에만 있습니다.
drafts-local-guest-note = 이 그림들은 이 기기에만 있습니다. 게시하려면 로그인하세요.
drafts-local-post = 게시하기
drafts-local-delete-confirm = 이 기기에서 그림을 삭제할까요? 되돌릴 수 없습니다.
drafts-local-community-denied = 이 계정으로는 그 커뮤니티에 게시할 수 없습니다. 개인 그림으로 게시할까요?
drafts-local-post-failed = 그림을 게시하지 못했습니다. 이 기기에는 그대로 남아 있습니다.
drafts-local-unavailable = 이 기기에는 그림을 보관할 수 없어서, 로그인하지 않고 저장한 그림은 여기 나오지 않습니다.
...
post-description = 내용
post-comments = 댓글
post-no-comments = 댓글이 없습니다.
post-no-comments-signin = 로그인하고 댓글을 달아 보세요.
post-comment = 댓글 달기
post-publish = 게시
post-move-community = 이 커뮤니티로 이동
post-move-community-title = 다른 커뮤니티로 게시물 이동
post-move-post-to-move = 이동할 게시물
post-current-community = 현재 커뮤니티
post-move-search-placeholder = 커뮤니티 검색...
post-move-available = 이동 가능한 커뮤니티
post-move-confirm = 정말로 이 게시물을 "{ $communityName }"(으)로 이동하시겠습니까?
post-move-no-results = 검색 조건과 일치하는 커뮤니티를 찾을 수 없습니다.
post-personal-post = 개인 게시물
post-personal-post-description = 이 게시물을 개인 프로필로 이동 (커뮤니티에 속하지 않음)
post-move-confirm-personal = 정말로 이 게시물을 개인 프로필로 이동하시겠습니까?
post-move-to-personal = 개인 프로필로 이동
move-section-unlisted = 참여한 커뮤니티
...
post-reaction = 반응
post-reactions = 반응
post-reaction-custom = 다른 이모지로 반응
post-reaction-custom-hint = 이모지 하나
post-reaction-custom-submit = 반응
post-share = 공유
post-share-copied = 링크가 클립보드에 복사되었습니다!
post-report = 신고
post-report-title = 이 게시물 신고하기
post-report-description-label = 신고 사유
post-report-description-placeholder = 이 게시물을 신고하는 이유를 설명해주세요...
...
replay-private-staff = 비공개 리플레이 (스태프에게만 표시)
sensitive = 민감한 내용
...
private-community-no-access = 이 비공개 커뮤니티에 접근할 수 없습니다.
relay-not-allowed = 이 그림은 작성자가 이어그리기를 허용하지 않았습니다.
...
community-drawing-orientation = 방향
community-drawing-landscape = 가로
community-drawing-portrait = 세로
community-no-posts = 게시된 그림이 없습니다.
community-drawing-post-error = 그림을 게시하는 도중 오류가 발생했습니다. 다시 제출해 보세요.
community-slug-conflict-error = 이 ID를 가진 커뮤니티가 이미 존재합니다. 다른 ID를 선택해 주세요.

profile-link = 링크
profile-manage = 관리
profile-banner = 동맹 배너
profile-draw-banner = 동맹 배너 그리기
profile-guestbook = 방명록
profile-following = 동맹
profile-public-community-posts = 공개 커뮤니티에서 그린 그림
profile-public-community-posts-nil = 공개 커뮤니티에서 그린 그림이 없습니다.
profile-private-community-posts = 비공개 커뮤니티에서 그린 그림 (프로필에 공개되지 않음)
profile-private-community-posts-nil = 비공개 커뮤니티에서 그린 그림이 없습니다.
profile-settings = 프로필 설정
profile-link-management = 링크 관리
profile-link-requires-verified-email = 이메일 인증을 완료해야 링크를 추가할 수 있습니다.
profile-link-order = 순서
profile-link-move-up = 위로
profile-link-move-down = 아래로
profile-link-delete = 삭제
profile-link-delete-confirm = 정말 링크를 삭제하시겠습니까?
profile-link-add = 링크 추가
profile-link-description = 링크 설명
profile-report = 신고
profile-report-title = 이 프로필 신고하기
profile-report-description-label = 신고 사유
profile-report-description-placeholder = 이 프로필을 신고하는 이유를 설명해주세요...
profile-report-submit = 신고하기
profile-report-success = 프로필이 신고되었습니다. 커뮤니티를 안전하게 유지하는 데 도움을 주셔서 감사합니다.
profile-report-error = 신고 제출에 실패했습니다. 다시 시도해주세요.
...
guestbook = 방명록
guestbook-write = 방명록 남기기
guestbook-empty = 방명록이 비어 있습니다.
guestbook-delete = 삭제
guestbook-delete-confirm = 정말 방명록을 삭제하시겠습니까?
guestbook-reply = 답글
guestbook-reply-write = 답글 남기기

account-info = 계정 정보
account-created-at = 가입일
account-info-edit = 계정 정보 변경
account-info-edit-success = 계정 정보가 수정되었습니다.
account-change-password = 비밀번호 변경
account-change-password-current = 현재 비밀번호
...
account-change-email = 이메일 변경
account-change-email-verified-at = 이메일 인증
account-change-email-email = 이메일
account-verify-email-request = 이메일 인증 요청
account-email-not-verified-warning = 이메일이 인증되지 않았습니다. 비밀번호를 분실하면 계정을 다시 찾을 수 없습니다.
account-change-email-token = 인증 코드
account-change-email-verify = 이메일 인증
account-change-email-error-token-mismatch = 인증 코드가 일치하지 않습니다.
account-change-email-error-token-expired = 인증 코드가 만료되었습니다.
account-change-email-error-already-verified = 이미 인증된 이메일 주소입니다.
account-change-email-success = 이메일 주소가 인증되었습니다.
account-change-email-subject = 오이카페 이메일 주소 인증 코드
account-delete = 계정 삭제
account-delete-warning = 계정을 삭제하면 모든 데이터가 삭제되며, 이 작업은 되돌릴 수 없습니다. 커뮤니티를 소유하고 있는 경우 먼저 소유권을 이전하거나 커뮤니티를 삭제해야 합니다.
account-delete-confirm = 정말로 계정을 삭제하시겠습니까? 이 작업은 되돌릴 수 없습니다.
account-delete-button = 계정 삭제
account-language-settings = 언어 설정
...
privacy-content = 오이카페는 회원님의 개인정보를 소중히 다룹니다. 기본적으로 오이카페 이용 시 개인정보를 수집하지 않습니다.
  ...
  이메일 주소: 회원가입 시 또는 프로필 업데이트 시 자발적으로 제공하는 경우에만 이메일 주소를 수집합니다. 이메일은 비밀번호 복구, 계정 인증 등 계정 관련 목적으로만 사용됩니다.

  데이터 사용: 회원님이 제공한 정보는 오직 오이카페 서비스 운영 및 개선을 위해서만 사용됩니다. 개인정보를 제3자에게 판매, 임대 또는 공유하지 않습니다.

  데이터 보안: 회원님의 정보를 무단 접근이나 유출로부터 보호하기 위해 합리적인 조치를 취하고 있습니다.

  회원님의 권리: 계정 설정을 통해 언제든지 본인의 계정 및 관련 데이터를 열람, 수정 또는 삭제할 수 있습니다.

  개인정보 처리방침에 대해 궁금한 점이 있으시면 문의해 주세요.

community-guidelines = 커뮤니티 가이드라인
community-guidelines-content = { brand }는 모든 사용자에게 안전하고 환영받는 존중의 환경을 제공하기 위해 노력합니다. 우리는 불쾌한 콘텐츠와 학대적 행동에 대해 무관용 원칙을 적용합니다.

  금지된 콘텐츠 및 행동:
  • 다른 사용자에 대한 괴롭힘, 위협 또는 따돌림
  • 인종, 민족, 종교, 성별, 성적 지향, 장애 또는 기타 보호 대상 특성에 기반한 혐오 발언이나 차별
  • 미성년자가 관련된 성적 콘텐츠 또는 비동의 성적 콘텐츠
  • 폭력 조장, 규제 물질 유통, 저작권 침해 등을 포함한 불법 콘텐츠 또는 활동
  • 스팸, 악성코드 또는 피싱 시도
  • 사칭 또는 신원 사기
  • 다른 사람의 동의 없이 개인정보를 공개하는 행위

  집행:
  이러한 가이드라인 위반 시 경고 없이 즉시 영구적으로 계정이 정지될 수 있습니다. 우리는 불법 활동을 법 집행 기관에 신고할 권리를 보유합니다.

  신고:
  이러한 가이드라인을 위반하는 콘텐츠나 행동을 발견하면 즉시 신고해 주세요. 우리는 모든 신고를 심각하게 받아들이고 신속하게 조사합니다.

  { brand }를 사용함으로써 귀하는 이러한 커뮤니티 가이드라인을 준수하는 데 동의합니다. 우리는 언제든지 이러한 가이드라인을 업데이트할 권리를 보유합니다.
...
apple-sign-in-unavailable = 지금은 Apple로 로그인할 수 없습니다.
apple-sign-in-continue = 계속
sign-in-with-google = Google로 로그인
google-sign-in-unavailable = 지금은 Google로 로그인할 수 없습니다.
handoff-confirm-link = 이 { $provider } 계정({ $account })을 지금 로그인한 계정에 연결할까요?
...
identity-linked-elsewhere = 이 { $provider } 계정은 이미 다른 오이카페 계정에 연결되어 있습니다.
identity-provider-already-linked = 이미 다른 { $provider } 계정이 연결되어 있습니다. 먼저 연결을 해제해 주세요.
identity-signed-in-as-other = 이 { $provider } 계정은 다른 오이카페 계정에 연결되어 있습니다. 사용하려면 먼저 로그아웃해 주세요.
identity-unlinked = { $provider } 계정 연결을 해제했습니다.
identity-unlink-last = 계정에 들어갈 수 있는 유일한 방법입니다. 연결을 해제하기 전에 비밀번호를 설정하거나 다른 계정을 연결해 주세요.
identity-welcome-title = 오이카페에 오신 것을 환영합니다
identity-welcome-body = { $provider } 계정 { $name }(으)로 로그인했습니다. 아이디를 정해 오이카페 계정을 만들어 주세요.
identity-welcome-body-unnamed = { $provider }(으)로 로그인했습니다. 아이디를 정해 오이카페 계정을 만들어 주세요.
identity-welcome-create = 계정 만들기
identity-welcome-link-existing = 로그인해서 { $provider } 연결하기
identity-cancel = 취소
identity-login-notice = 로그인하면 { $provider } 계정이 오이카페 계정에 연결됩니다.
login-name-invalid = 영문, 숫자, _, - 로 50자까지 쓸 수 있습니다.
login-name-taken = 이미 사용 중인 아이디입니다. 다른 아이디를 선택해 주세요.
display-name-required = 닉네임을 입력해 주세요.
account-linked-accounts = 연결된 계정
account-linked-accounts-none = 연결된 계정이 없습니다.
account-unlink = 연결 해제
account-link-steam = Steam 계정 연결하기
account-link-apple = Apple 계정 연결하기
account-link-google = Google 계정 연결하기
account-set-password = 비밀번호 설정
account-set-password-hint = 아직 비밀번호가 없습니다. 비밀번호를 설정하면 웹과 모바일 앱에서도 로그인할 수 있습니다.
account-delete-type-login-name = 확인을 위해 아이디({ $loginName })를 입력하세요
profile-achievements = 업적
achievement-first-drawing = 첫 그림
achievement-first-drawing-description = 처음으로 그림을 올렸습니다.
achievement-first-relay = 첫 이어그리기
achievement-first-relay-description = 처음으로 다른 사람의 그림에 이어그렸습니다.
achievement-first-collaboration = 첫 함께 그리기
achievement-first-collaboration-description = 처음으로 다른 사람과 함께 그렸습니다.
achievement-steam-supporter = Steam 후원자
achievement-steam-supporter-description = Steam에서 오이카페를 후원했습니다.
supporter-pack = 후원 팩
supporter-pack-lede = 오이카페는 무료이고, 앞으로도 무료입니다. 후원 팩을 구매하셔서 오이카페를 응원해 주세요.
supporter-pack-year = { $year } 후원 팩
supporter-pack-what = 올해 팩을 사면 이름이 보이는 곳마다 올해의 표식이 붙고, 소개 페이지에 이름이 실립니다. 내년에는 내년 팩이 나옵니다.
supporter-pack-have = { $year } 후원 팩을 가지고 계십니다. 고맙습니다.
supporter-pack-buy = { $year } 후원 팩 구입
supporter-pack-restore = 구매 복원
supporter-pack-checking = 스토어에 구매를 확인하고 있습니다…
supporter-pack-restored = 구매를 복원했습니다.
supporter-pack-nothing-to-restore = 이 스토어 계정에는 복원할 후원 팩이 없습니다.
supporter-pack-pending = 구매가 승인을 기다리고 있습니다. 승인되면 팩이 여기에 나타납니다.
supporter-pack-failed = 구매가 완료되지 않았습니다. 다시 시도해 주세요.
supporter-pack-refused = 스토어에서 이 구매를 확인할 수 없어 팩을 추가하지 못했습니다.
supporter-pack-later = 지금은 구매를 확인할 수 없습니다. 구매는 그대로 남아 있으며, 다음에 이 페이지를 열 때 추가됩니다.
supporter-pack-sign-in = 팩이 담길 계정이 필요하니 먼저 로그인해 주세요.
supporter-pack-none = 아직 { $year } 후원 팩은 판매하지 않습니다.
supporter-pack-elsewhere = 팩은 오이카페 앱 안에서 판매합니다.
supporter-pack-years = 후원하신 해
supporter-pack-years-help = 한 번 산 팩은 계속 남고, 이름 옆의 표식은 올해 팩의 것입니다.
...
account-supporter = 후원자
account-supporter-thanks = 오이카페를 후원해 주셔서 고맙습니다. 올해의 표식이 이름이 보이는 곳마다 함께 표시되고, 프로필에는 후원하신 모든 해가 남습니다.
account-supporter-mark = 이름 옆에 표시할 표식
account-show-in-credits = 오이카페 소개 페이지에 내 이름 싣기
account-supporter-see-credits = 후원자 보기
profile-tabs-label = 그림
profile-tab-public = 공개
profile-tab-private = 비공개
profile-tab-drawings = 그림
profile-tab-comments = 댓글
profile-more = 더 보기
