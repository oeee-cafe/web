...
supporter-pack-have = You have the { $year } pack. Thank you.
supporter-pack-buy = Buy the { $year } pack
supporter-pack-restore = Restore purchases
supporter-pack-sign-in = Sign in first, so the pack has an account to belong to.
supporter-pack-none = There is no { $year } pack for sale yet.
supporter-pack-elsewhere = The pack is sold inside the iOS app and the Steam app.
