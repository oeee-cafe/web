...
draw-guest-notice = You're not signed in. Saving keeps this drawing in this browser only.
draw-guest-save-confirm = Save this drawing in this browser? You can post it from your drafts once you sign in.
draw-guest-saved-title = Saved in this browser
draw-guest-saved = This drawing is only in this browser, not on the site. Clearing this site's data deletes it, and so does Safari after a week without a visit. Sign in to post it from your drafts, or download a copy.
...
draw-upload-failed-lost = Couldn't post this drawing, and this browser can't keep it. Try again, or download the PNG.
drafts-local-heading = In this browser
drafts-local-note = These drawings are only in this browser until you post them.
drafts-local-guest-note = These drawings are only in this browser. Sign in or sign up to post them.
drafts-local-post = Post
drafts-local-delete-confirm = Delete this drawing from this browser? It can't be recovered.
drafts-local-community-denied = This account can't post in that community. Post it as a personal drawing instead?
drafts-local-post-failed = Couldn't post this drawing. It's still kept in this browser.
drafts-local-unavailable = This browser can't keep drawings, so any drawing saved while signed out isn't shown here.
