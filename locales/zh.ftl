...
supporter-pack-year = { $year } 年礼包
supporter-pack-what = 买下今年的礼包，你的名字出现的地方都会带上今年的标记，关于页面也会列出你的名字。明年会有明年的礼包。
supporter-pack-have = 你已拥有 { $year } 年礼包。谢谢你。
supporter-pack-buy = 购买 { $year } 年礼包
supporter-pack-restore = 恢复购买
supporter-pack-sign-in = 礼包需要归属的账号，请先登录。
supporter-pack-none = { $year } 年礼包尚未开售。
supporter-pack-elsewhere = 礼包在 iOS 应用和 Steam 应用内出售。
