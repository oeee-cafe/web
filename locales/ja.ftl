...
draw-guest-notice = ログインしていません。保存すると、この絵はこのブラウザにだけ保存されます。
draw-guest-save-confirm = この絵をこのブラウザに保存しますか？ログインすると下書きから投稿できます。
draw-guest-saved-title = このブラウザに保存しました
draw-guest-saved = この絵はサイトではなく、このブラウザにだけあります。サイトのデータを消去すると消え、Safari では一週間アクセスしないと消えます。ログインすると下書きから投稿できます。コピーをダウンロードしておくこともできます。
...
draw-upload-failed-lost = 絵を投稿できず、このブラウザにも保存できません。もう一度試すか、PNG をダウンロードしてください。
drafts-local-heading = このブラウザにある絵
drafts-local-note = これらの絵は、投稿するまでこのブラウザにだけあります。
drafts-local-guest-note = これらの絵はこのブラウザにだけあります。投稿するにはログインか新規登録をしてください。
drafts-local-post = 投稿する
drafts-local-delete-confirm = この絵をこのブラウザから削除しますか？元に戻せません。
drafts-local-community-denied = このアカウントではそのコミュニティに投稿できません。個人の絵として投稿しますか？
drafts-local-post-failed = 絵を投稿できませんでした。このブラウザにはそのまま残っています。
drafts-local-unavailable = このブラウザには絵を保存できないため、ログインせずに保存した絵はここに表示されません。
