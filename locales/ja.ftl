...
supporter-pack-year = { $year }年のパック
supporter-pack-what = 今年のパックを買うと、お名前が表示されるところに今年のマークが添えられ、クレジットにお名前が載ります。来年には来年のパックがあります。
supporter-pack-have = { $year }年のパックをお持ちです。ありがとうございます。
supporter-pack-buy = { $year }年のパックを買う
supporter-pack-restore = 購入を復元
supporter-pack-sign-in = パックの持ち主になるアカウントが要るので、先にサインインしてください。
supporter-pack-none = { $year }年のパックはまだ販売していません。
supporter-pack-elsewhere = パックはiOSアプリとSteamアプリの中で販売しています。
