...
about-supporters-thanks = SteamでOEEEカフェを支援し、みんなのためにカフェを支えてくれている方々です。ありがとうございます。
account-supporter = サポーター
account-supporter-thanks = OEEEカフェを支援していただき、ありがとうございます。お名前が表示されるところには、ハートが添えられます。
